...
def test():
    n = NetGen('res_cg_ebm_fw',
               'scaled_began_gmsm_b16_z256_sz128_h128_g0.7_elu_pconv_wxav_alphas',
               'celebc',
               [{'dir': 'base_block', 'data': 'celebc8', 'glr': 8e-5, 'dlr': 2e-6},
                {'dir': 'block1', 'data': 'celebc16', 'glr': 8e-5, 'dlr': 8e-5},
                {'dir': 'block2', 'data': 'celebc32', 'glr': 8e-5, 'dlr': 8e-5},
                {'dir': 'block3', 'data': 'celebc64', 'glr': 8e-5, 'dlr': 8e-5},
                {'dir': 'block4', 'data': 'celebc128', 'glr': 2e-5, 'dlr': 2e-5}],
               branching=False)
