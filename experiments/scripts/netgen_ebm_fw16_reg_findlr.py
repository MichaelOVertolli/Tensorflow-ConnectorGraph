...
def test():
    ...
    for i in range(100):
        ...
        n = NetGen('res_cg_ebm_fw16_reg',
                   'b16_z128_sz64_h128_gms0.0_chrom0.0_g0.5_elu_pconv_wxav_alphas',
                   'celebc/growing/param_search_lr',
                   [{'dir': 'base_block', 'data': 'celebcr', 'glr': glr, 'dlr': dlr, 'fetch_size': 5000, 'resize': [16, 16]},
                   {'dir': 'block1', 'data': 'celebcr', 'glr': glr, 'dlr': dlr, 'fetch_size': 5000, 'resize': [32, 32]},
                   {'dir': 'block2', 'data': 'celebcr', 'glr': glr, 'dlr': dlr, 'fetch_size': 5000, 'resize': [64, 64]},],
                   branching=False)
        try:
            n.run()
        ...
        print event_dir
        write_data('./logs/celebc/growing/param_search_lr', event_dir,
