...
def test():
    ...
    log_dir = '/home/olias/data/celeb_all'
    size = [32, 32]
    alpha = 0.1
    pdist = pos_dist_mat(size[0])
    pdist.next()
    with open('/home/olias/data/celeb_dists/splits_women.pkl', 'r') as f:
    ...
    for k in splits.keys():
        ...
        center, dists = emd_from_center(files, imgs, gimgs, sift_sq, pdist, alpha, sift)
        all_dists[k] = (center, dists)
    # im1 = Image.open(f1)
    # im2 = Image.open(f2)
    # size = [32, 32]
    ...
    return splits, imgs, all_dists# im1, im2, im1g, im2g, siftemd, coloremd
