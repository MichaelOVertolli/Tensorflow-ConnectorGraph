...
def test():
    n = NetGen('res_cg_ebm_fw_full32_bw',
               'began_b16_z128_sz32_h128_g0.6_elu_pconv_wxav',
               'mnist',
               [{'dir': 'base_block', 'data': 'mnist32', 'glr': 9e-6, 'dlr': 7e-7, 'fetch_size': 5000, 'resize': [32, 32]},],
               branching=False)
