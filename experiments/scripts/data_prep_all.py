...
def setup(mnist=None, celeb=None, cifar10=None):
    ...
    if celeb is not None:
        ...
        celeb_to_imgs(celeb_train, imgs_dir='/home/olias/data/img_align_celeba', train=True, all_dir=celeb_all)
        celeb_to_imgs(celeb_test, imgs_dir='/home/olias/data/img_align_celeba', train=False, all_dir=celeb_all)
        print 'Finished saving images.'
        print 'Starting tfrecords.'
