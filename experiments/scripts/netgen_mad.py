...
def test():
    n = NetGen('res_cg_ebm_mad',
               'began_b16_z128_sz64_h128_g0.7_elu_pconv_wxav_alphas',
               'celebc',
               [{'dir': 'base_block', 'data': 'celebcr', 'glr': 2e-4, 'dlr': 7e-6, 'fetch_size': 5000, 'resize': [16, 16], 'filter_value': 0.8},
                {'dir': 'block2', 'data': 'celebcr', 'glr': 2e-4, 'dlr': 7e-6, 'fetch_size': 5000, 'resize': [32, 32], 'filter_value': 0.6},
                {'dir': 'block3', 'data': 'celebcr', 'glr': 2e-4, 'dlr': 7e-6, 'fetch_size': 5000, 'resize': [64, 64], 'filter_value': 0.4},],
               bool_mask=True,
               branching=True)
