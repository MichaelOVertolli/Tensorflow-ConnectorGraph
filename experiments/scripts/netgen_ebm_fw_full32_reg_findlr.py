...
def test():
    ...
    #     dlr = float('{}e-{}'.format(*de))
        ...
        #     d1, e1 = randint(1, 9), randint(4, 7)
            ...
            n = NetGen('res_cg_ebm_fw_full32_reg',
                       'b16_z128_sz32_h128_gms0.0_chrom0.0_g0.9_elu_pconv_wxav',
                       'celebc/param_search_lr_grid',
                       [{'dir': 'base_block', 'data': 'celebcr', 'glr': glr, 'dlr': dlr, 'fetch_size': 5000, 'resize': [32, 32]},],
                       branching=False)
            try:
                n.run()
            ...
            print event_dir
            write_data('./logs/celebc/param_search_lr_grid', event_dir,
