...
def build(config):
    ...
    G.add_edges_from([
        ...
        (GNF2, BRGF, {'out': OUTP, 'in': INPT, 'mod': BRGF}),
        (BRGF, CNCT, {'out': OUTP, 'in': G_IN}),
        (CNCT, BRGD, {'out': OUTP, 'in': INPT}),
        (BRGD, DSC2, {'out': OUTP, 'in': INPT, 'mod': BRGD}),
        ...
        (DGN2, BRGU, {'out': OUTP, 'in': INPT, 'mod': BRGU}),
        ...
        (ALIN, GNF2, {'out': ALPH.format(2), 'in': ALPH.format(2)}),
        (ALIN, DSC0, {'out': ALPH.format(0), 'in': ALPH.format(0)}),
        (ALIN, DSC0, {'out': ALPH.format(1), 'in': ALPH.format(1)}),
        (ALIN, DSC0, {'out': ALPH.format(2), 'in': ALPH.format(2)}),
        (ALIN, DGN0, {'out': ALPH.format(0), 'in': ALPH.format(0)}),
        (ALIN, DGN1, {'out': ALPH.format(1), 'in': ALPH.format(1)}),
        (ALIN, DGN2, {'out': ALPH.format(2), 'in': ALPH.format(2)}),
    ])
